// JWF1026-160(10)厂家PDF第9页：按本页原格独立生成3D规格。
import {jwf1026P03P10Verified} from '../jwf1026-p03-p10-verified.js';

const rows=jwf1026P03P10Verified.filter(part=>part.page===9);
...
export const jwf1026P09ModelSpecs=Object.fromEntries(rows.map(part=>[part.recordKey,makeSpec(part)]));
export default jwf1026P09ModelSpecs;
