// JWF1012厂家PDF第14页：按本页原格独立生成3D规格。
import {jwf1012P04P15Verified} from '../jwf1012-p04-p15-verified.js';

const rows=jwf1012P04P15Verified.filter(part=>part.page===14);
...
export const jwf1012P14ModelSpecs=Object.fromEntries(rows.map(part=>[part.recordKey,makeSpec(part)]));
export default jwf1012P14ModelSpecs;
