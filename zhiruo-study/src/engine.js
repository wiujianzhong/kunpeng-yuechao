...
export const STORAGE_KEY = "zhiruo-gaokao-state-v1";
...
export function hydrateState(rawState, now = new Date()) {
  ...
  return {
    ...initial,
    ...rawState,
    profile: { ...initial.profile, ...savedProfile, name: !savedProfile.name || savedProfile.name === "星航员" ? "梁芷若" : savedProfile.name },
