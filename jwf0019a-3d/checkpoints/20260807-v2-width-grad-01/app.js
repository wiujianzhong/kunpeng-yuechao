...
function rebuildFactoryConnections(syncSlopeFromLayout = true) {
  ...
  upstreamProcessCurve = new THREE.CatmullRomCurve3([
    upstreamStartInside,
    jwf1124Outline.outlet.clone().addScaledVector(jwfOutletDirection, factoryMetric(lineLayoutParams.upstreamLeadMm / 1000)),
    jwf1124Outline.outlet.clone().addScaledVector(jwfOutletDirection, factoryMetric(0.18))
      .addScaledVector(new THREE.Vector3(0, 1, 0), factoryMetric(0.10)),
    jwf1124Outline.outlet.clone().addScaledVector(upstreamSlopeDirection, factoryMetric(0.45)),
